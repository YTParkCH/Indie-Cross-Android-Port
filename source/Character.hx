		...
		switch (curCharacter)
		{
			...
			*/
				...
				case 'cuphead':
					...
					tex = Paths.getSparrowAtlas('characters/Cuphead Sprites', 'shared');
					frames = tex;
					animation.addByPrefix('idle', 'Cuphead_standing instance', 24);
					animation.addByPrefix('singUP', 'CupUp instance', 24);
					animation.addByPrefix('singRIGHT', 'CupyRight instance', 24);
					animation.addByPrefix('singDOWN', 'CupON THE GROUND NOW instance', 24);
					animation.addByPrefix('singLEFT', 'Cupleft instance', 24);
	
					addOffset('idle', 341, -204);
					addOffset("singUP", 354, -108);
					addOffset("singRIGHT", 290, -193);
					addOffset("singLEFT", 386, -203);
					addOffset("singDOWN", 301, -215);
	
					playAnim('idle');

					case 'cuphead pissed':
						// CUPHEAD IS PISSED ANIMATION LOADING CODE
						tex = Paths.getSparrowAtlas('characters/Cuphead_Remastered', 'shared');
						frames = tex;
						animation.addByPrefix('idle', '1 instance', 24);
					...
					case 'bf cuphead':
						...
						case 'bf rain':
							...
							case 'sases':
								// SASES ANIMATION LOADING CODE
								tex = Paths.getSparrowAtlas('characters/sases', 'shared');
								frames = tex;
								...
								case 'sans':
									// SANS ANIMATION LOADING CODE
									tex = Paths.getSparrowAtlas('characters/Sans', 'shared');
									frames = tex;
									animation.addByPrefix('idle', 'Sans FNF instance', 24);
									animation.addByPrefix('singUP', 'Up instance', 24);
									animation.addByPrefix('singRIGHT', 'Right instance', 24);
									animation.addByPrefix('singDOWN', 'Down instance', 24);
									animation.addByPrefix('singLEFT', 'Left instance', 24);
